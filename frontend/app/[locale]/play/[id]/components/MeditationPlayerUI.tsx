  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black text-white flex flex-col font-sans overflow-hidden">
      ...
      <div className="relative z-10 flex justify-between items-center px-6 py-6 pt-12">
        <Link href="./../../home" className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 hover:bg-white/20 transition-colors">
          <X className="w-6 h-6" />
        </Link>
