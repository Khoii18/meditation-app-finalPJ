    ...
    <div className="w-full min-h-screen bg-[#050510] text-indigo-100 overflow-hidden relative font-sans pt-12 pb-24">
      ...
      <div className="relative z-10 w-full max-w-lg mx-auto">
        <header className="text-center mb-6 px-4">
          <h1 className="text-4xl text-white font-serif font-medium mb-2">Quỹ Đạo Tĩnh Thức</h1>
          <p className="text-indigo-300/80 text-sm">Hành trình 10 ngày khai mở tiềm năng nhận thức.</p>
        </header>
          ...
          {nodes.map((node, i) => (
            ...
            >
              <div className="relative group cursor-pointer flex flex-col items-center">
                {/* Node Ring */}
                {node.status === "active" && (
                  <div className="absolute inset-0 bg-indigo-500 rounded-full blur-lg opacity-50 animate-pulse scale-150" />
                )}
