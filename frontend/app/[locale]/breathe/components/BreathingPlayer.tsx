...
export function BreathingPlayer() {
  ...
  const phases: Record<BreathState, { text: string; duration: number; scale: number; borderRadius: string }> = {
    inhale: { text: "Từ từ hít vào...", duration: 4, scale: 1.5, borderRadius: "40% 60% 70% 30% / 40% 50% 60% 50%" },
    hold: { text: "Giữ hơi thở", duration: 7, scale: 1.5, borderRadius: "50% 50% 50% 50% / 50% 50% 50% 50%" },
    exhale: { text: "Thở ra nhẹ nhàng...", duration: 8, scale: 1, borderRadius: "60% 40% 30% 70% / 60% 30% 70% 40%" },
    rest: { text: "Chuẩn bị", duration: 0, scale: 1, borderRadius: "50% 50% 50% 50% / 50% 50% 50% 50%" }
  };
