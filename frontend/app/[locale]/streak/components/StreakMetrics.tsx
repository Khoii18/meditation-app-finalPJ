...
export function StreakMetrics() {
  const metrics = [
    { label: "Longest Streak", value: "24 Days", icon: <Star className="w-5 h-5 text-amber-500" /> },
    { label: "Total Sessions", value: "115", icon: <Zap className="w-5 h-5 text-indigo-500" /> },
    { label: "Mindful Minutes", value: "1,240", icon: <CalendarDays className="w-5 h-5 text-emerald-500" /> },
  ];
