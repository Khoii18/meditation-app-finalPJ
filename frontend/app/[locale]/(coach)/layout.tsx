      ...
      <aside className="w-64 border-r border-slate-200 dark:border-white/10 hidden md:flex flex-col bg-white dark:bg-[#1C1C1E]">
        <div className="p-6">
          <Link href="./../../home" className="flex items-center gap-2">
            ...
            <span className="font-serif font-bold text-xl tracking-wide">Mindful<span className="text-indigo-500">Coach</span></span>
          </Link>
        </div>
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          ...
          <Link href="./coach" className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400 font-medium">
            <LayoutDashboard className="w-5 h-5" />
            Dashboard
          </Link>
          <Link href="?tab=content" className="flex items-center gap-3 px-4 py-3 rounded-2xl text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors font-medium">
